...
class MCTS:
    ...
    """
    #########################################################
    Bernoulli Thompson Sampling implementation Start from here
    ...
    @staticmethod
    def t_beta(alpha, beta):
        return numpy.random.beta(alpha+1, beta+1)

    def thompson(self, parent, child, min_max_stats):

        prior_score = self.t_beta(child._alpha, child._beta)
...
class Node:
    ...
    """
    #########################################################
    Bernoulli Thompson Sampling implementation End here
    Saiham Rahman. ID: 210769593
    #########################################################
    """
